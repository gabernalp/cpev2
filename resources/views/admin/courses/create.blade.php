        ...
        <form method="POST" action="{{ route("admin.courses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('support_required') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="support_required" id="support_required" value="1" {{ old('support_required', 0) == 1 || old('support_required') === null ? 'checked' : '' }}>
