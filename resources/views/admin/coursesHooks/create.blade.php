    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.courses-hooks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('specific_category') ? 'is-invalid' : '' }}" type="text" name="specific_category" id="specific_category" value="{{ old('specific_category', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('educational_level_exclusive') ? 'is-invalid' : '' }}" name="educational_level_exclusive" id="educational_level_exclusive">
                    ...
                    @foreach(App\Models\CoursesHook::EDUCATIONAL_LEVEL_EXCLUSIVE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('educational_level_exclusive', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('community') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="community" id="community" value="1" {{ old('community', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('institutional') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="institutional" id="institutional" value="1" {{ old('institutional', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('family') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="family" id="family" value="1" {{ old('family', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('intercultural') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="intercultural" id="intercultural" value="1" {{ old('intercultural', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('coordinator') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="coordinator" id="coordinator" value="1" {{ old('coordinator', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('educational_group') ? 'is-invalid' : '' }}" name="educational_group" id="educational_group">
                    ...
                    @foreach(App\Models\CoursesHook::EDUCATIONAL_GROUP_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('educational_group', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
