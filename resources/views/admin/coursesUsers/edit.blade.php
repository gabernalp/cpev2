    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.courses-users.update", [$coursesUser->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('challenges') ? 'is-invalid' : '' }}" type="text" name="challenges" id="challenges" value="{{ old('challenges', $coursesUser->challenges) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('feedbacks') ? 'is-invalid' : '' }}" type="text" name="feedbacks" id="feedbacks" value="{{ old('feedbacks', $coursesUser->feedbacks) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('badges') ? 'is-invalid' : '' }}" type="text" name="badges" id="badges" value="{{ old('badges', $coursesUser->badges) }}">
