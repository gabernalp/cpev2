    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events-schedules.update", [$eventsSchedule->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $eventsSchedule->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('newsletter') ? 'is-invalid' : '' }}" name="newsletter" id="newsletter">{{ old('newsletter', $eventsSchedule->newsletter) }}</textarea>
