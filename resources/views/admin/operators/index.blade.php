...
@can('operator_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.operators.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Operator">
            <thead>
                <tr>
                    <th width="10">
...
@can('operator_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.operators.massDestroy') }}",
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Operator').DataTable(dtOverrideGlobals);
