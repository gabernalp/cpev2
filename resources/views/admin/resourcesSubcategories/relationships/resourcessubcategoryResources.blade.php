...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-resourcessubcategoryResources">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-resourcessubcategoryResources:not(.ajaxTable)').DataTable({ buttons: dtButtons })
