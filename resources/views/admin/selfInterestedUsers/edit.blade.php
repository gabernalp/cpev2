            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('documenttype') ? 'is-invalid' : '' }}" name="documenttype_id" id="documenttype_id" required>
                    @foreach($documenttypes as $id => $documenttype)
                        <option value="{{ $id }}" {{ (old('documenttype_id') ? old('documenttype_id') : $selfInterestedUser->documenttype->id ?? '') == $id ? 'selected' : '' }}>{{ $documenttype }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('department') ? 'is-invalid' : '' }}" name="department_id" id="department_id">
                    @foreach($departments as $id => $department)
                        <option value="{{ $id }}" {{ (old('department_id') ? old('department_id') : $selfInterestedUser->department->id ?? '') == $id ? 'selected' : '' }}>{{ $department }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id">
                    @foreach($cities as $id => $city)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $selfInterestedUser->city->id ?? '') == $id ? 'selected' : '' }}>{{ $city }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('courseshooks') ? 'is-invalid' : '' }}" name="courseshooks[]" id="courseshooks" multiple>
                    @foreach($courseshooks as $id => $courseshooks)
                        <option value="{{ $id }}" {{ (in_array($id, old('courseshooks', [])) || $selfInterestedUser->courseshooks->contains($id)) ? 'selected' : '' }}>{{ $courseshooks }}</option>
                    @endforeach
                </select>
