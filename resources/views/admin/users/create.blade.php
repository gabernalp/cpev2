    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('labour_role') ? 'is-invalid' : '' }}" name="labour_role" id="labour_role">
                    ...
                    @foreach(App\Models\User::LABOUR_ROLE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('labour_role', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('motivation') ? 'is-invalid' : '' }}" name="motivation" id="motivation">{{ old('motivation') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('experience') ? 'is-invalid' : '' }}" name="experience" id="experience">
                    ...
                    @foreach(App\Models\User::EXPERIENCE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('experience', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
